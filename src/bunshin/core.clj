...
(comment
  ...
  (store! ctx "foo" "hello world" :id 20 :ttl 10) ;; :ok

  ;;; Request 1 to 127.0.0.1:6379
  ;;; zrevrange "bunshinids:foo" 0 -1 "withscores"
  (store! ctx "foo" "hello world new" :id 20) ;; :stale-write
  ...
  ;;; del "foo:20"
  (store! ctx "foo" "hello world new" :id 21) ;; :ok
  ...
  ;;; zadd "bunshinids:foo" 20 1
  ;;; set "foo:20" "hello world"
  (store! ctx "foo" "hello world" :id 20) ;; :ok
